...
# Confirmed 2026-05-03 by capturing the STIGA.GO app pressing "Reset error"
# (locale string `commonResetError`). Wire frame is `08 25 18 25` — no params,
# only cmd_id + echo. Robot replies with cmd_ack result=1 (OK).
ROBOT_CMD_RESET_ERROR = 37
...
ROBOT_CMD_NAMES: dict[int, str] = {
    ...
    ROBOT_CMD_RESET_ERROR: "RESET_ERROR",
